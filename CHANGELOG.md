...
All notable changes to the "ContextHub" extension will be documented in this file.
...
The first public release of ContextHub (formerly cursor-contexts)!
...
This initial release establishes ContextHub as a powerful tool for organizing project knowledge and integrating with AI assistants. Key highlights:
...
2. **Install ContextHub**: From marketplace or VSIX
3. **Update settings**: Rename configuration keys:
   - `cursorContexts.*` → `contexthub.*`
...
- 🐛 **Bug Reports**: [GitHub Issues](https://github.com/cxt-hub/contexthub-vscode/issues)
- 💡 **Feature Requests**: [GitHub Issues](https://github.com/cxt-hub/contexthub-vscode/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/cxt-hub/contexthub-vscode/discussions)
- 📖 **Documentation**: [README](https://github.com/cxt-hub/contexthub-vscode#readme)

---

[Unreleased]: https://github.com/cxt-hub/contexthub-vscode/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/cxt-hub/contexthub-vscode/releases/tag/v1.0.0

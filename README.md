# ContextHub for VS Code

<div align="center">

![ContextHub Logo](resources/icon.png)

**Organize your project knowledge and supercharge your AI assistants**

[![VS Code Marketplace](https://img.shields.io/visual-studio-marketplace/v/cxthub.contexthub-vscode?style=flat-square&label=VS%20Code%20Marketplace&logo=visual-studio-code)](https://marketplace.visualstudio.com/items?itemName=cxthub.contexthub-vscode)
[![Installs](https://img.shields.io/visual-studio-marketplace/i/cxthub.contexthub-vscode?style=flat-square)](https://marketplace.visualstudio.com/items?itemName=cxthub.contexthub-vscode)
[![Rating](https://img.shields.io/visual-studio-marketplace/r/cxthub.contexthub-vscode?style=flat-square)](https://marketplace.visualstudio.com/items?itemName=cxthub.contexthub-vscode)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://opensource.org/licenses/MIT)
[![GitHub issues](https://img.shields.io/github/issues/cxt-hub/contexthub-vscode?style=flat-square)](https://github.com/cxt-hub/contexthub-vscode/issues)
...
ContextHub is a powerful VS Code extension that helps you organize project-specific knowledge and seamlessly integrate it with AI assistants like **GitHub Copilot**, **Cursor AI**, and other LLM-powered tools.
...
ContextHub creates organized **context projects** that:
...
# Then install:
code --install-extension contexthub-vscode-1.0.0.vsix

# For Cursor IDE:
cursor --install-extension contexthub-vscode-1.0.0.vsix
```

### From Source

```bash
git clone https://github.com/cxt-hub/contexthub-vscode.git
cd contexthub-vscode
npm install
npm run compile
vsce package
code --install-extension contexthub-vscode-1.0.0.vsix
...
Open the **ContextHub** view in the sidebar (Activity Bar icon) and click **"Create New Project"**.
...
- Press `Cmd+Shift+P`
- Type "ContextHub: Show Project Status"
...
Configure ContextHub in your VS Code settings:

```json
{
  // Folder name for context projects
  "contexthub.contextsFolderName": ".contexts",
  
  // Show welcome message
  "contexthub.showWelcomeMessage": true,
  
  // Auto-sync settings
  "contexthub.autoSync.enabled": true,
  "contexthub.autoSync.intervalMinutes": 60,
  "contexthub.autoSync.notifyOnChanges": true
}
```
...
| Command | Description |
|---------|-------------|
| `ContextHub: Create New Project` | Create a new context project |
| `ContextHub: Clone from GitHub` | Clone a repository as a context project |
| `ContextHub: Show Project Status` | View dashboard of all projects |
| `ContextHub: Show All TODO Tasks` | Scan for TODO/FIXME comments |
| `ContextHub: Show Recent Changes` | View Git commit history |
| `ContextHub: Sync All Projects` | Update all Git repositories |
| `ContextHub: Enable/Disable Project` | Toggle project visibility to AI |
...
Found a bug or have an idea? [Open an issue](https://github.com/cxt-hub/contexthub-vscode/issues/new)!
...
If ContextHub helps your development workflow:
...
- [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=cxthub.contexthub-vscode)
- [GitHub Repository](https://github.com/cxt-hub/contexthub-vscode)
- [Issue Tracker](https://github.com/cxt-hub/contexthub-vscode/issues)
...
![GitHub stars](https://img.shields.io/github/stars/cxt-hub/contexthub-vscode?style=social)
![GitHub forks](https://img.shields.io/github/forks/cxt-hub/contexthub-vscode?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/cxt-hub/contexthub-vscode?style=social)

---

<div align="center">

**Made with ❤️ by the ContextHub Community**

[⬆ Back to Top](#contexthub-for-vs-code)

...
Thank you for your interest in contributing to ContextHub! 🎉
...
This project and everyone participating in it is governed by the [ContextHub Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to the project maintainers.
...
Before creating bug reports, please check the [issue tracker](https://github.com/cxt-hub/contexthub-vscode/issues) to avoid duplicates.
...
Look for issues labeled [`good first issue`](https://github.com/cxt-hub/contexthub-vscode/labels/good%20first%20issue) - these are great for newcomers!

#### What to Work On

- Check [open issues](https://github.com/cxt-hub/contexthub-vscode/issues)
...
2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR_USERNAME/contexthub-vscode.git
   cd contexthub-vscode
   ```

3. **Add upstream remote**
   ```bash
   git remote add upstream https://github.com/cxt-hub/contexthub-vscode.git
   ```
...
1. **Install development extension**
   ```bash
   npm run compile
   code --install-extension contexthub-vscode-1.0.0.vsix --force
   ```
...
Thank you for contributing to ContextHub! 🚀
